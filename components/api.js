...
export const FAKE_EMAILS = [
  ...
  },
  {
    ...
    body: "If you send me your bank account number I will reward you with $10 million whole US dollars.",
  },
];

// Generate a preview
FAKE_EMAILS.forEach((email) => (email.preview = email.body.slice(0, 46)));
